                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      mainAxisAlignment: toDotasks[index].desc.isEmpty
                                        ...
                                        Text(
                                         toDotasks[index].title,
                                          style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                            decoration:  toDotasks[index].isCompleted
                                                ? TextDecoration.lineThrough
                                                : TextDecoration.none,
                                            decorationThickness: 2,
                                              decorationColor:tasksModel[index].isCompleted? Color(0xFF6A6A6A):null,
                                            color:toDotasks[index].isCompleted? Color(0xFF6A6A6A):null
                                         ...
                                         toDotasks[index].desc,
                                          style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                              decoration:  toDotasks[index].isCompleted
                                                  ...
                                                  : TextDecoration.none,
                                              decorationThickness: 2,
                                              decorationColor:toDotasks[index].isCompleted? Color(0xFF6A6A6A):null,
                                              color:toDotasks[index].isCompleted? Color(0xFF6A6A6A):null
                                          ),
                                        ),
                                      ],
